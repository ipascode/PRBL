class RepairsController < ApplicationController
  ...
  private
    ...
    def repair_params
      params.require(:repair).permit(:datestarted, :datefinished, :repairtype, :Driver_id, :Bus_id, :location, :jobcard_num, jobs_attributes: [:id, :timestarted, :timefinished, :jobparticular, :done, :_destroy])
    end
end
